<template>
  <div class="contenedor-permi" v-if="username">
    ...
    <div>
      <div class="row filas">
        <div
          class="col-sm-4 col-md-3 col-xl-3 columnas"
        ...
        <div class="col-sm-4 col-md-3 col-xl-3 columnas" v-if="permisoCrearRol">
        ...
        <div class="col-sm-4 col-md-3 col-xl-3 columnas" v-if="permisoEmpresa">
        ...
        >
          <a class="redireccion" href="/cotizaciones">
            <card-permiso
              ...
              contenido="Usted puede realizar la correspondiente cotización de las solicitud aceptadas ya sea en formato digital o impreso"
            ></card-permiso>
          </a>
        </div>
        <div
        ...
        >
          <a class="redireccion" href="/filtro_cotizaciones">
            <card-permiso
              ...
              contenido="Usted puede ver todas las cotizaciones por diferentes filtros : fechas, item/servicios , rubro de una empresa y mas."
            >
            </card-permiso>
          </a>
        </div>
        ...
        >
          <a class="redireccion" href="/presupuestos">
            <card-permiso
              ...
              contenido="Usted puede registrar , editar todos los presupuestos por unidad de gasto ."
            >
            </card-permiso>
          </a>
        </div>
        ...
        <div class="col-sm-4 col-md-3 col-xl-3 columnas" v-if="permisoBitacora">
        ...
        <div class="col-sm-4 col-md-3 col-xl-3 columnas" v-if="permisoBackup">
