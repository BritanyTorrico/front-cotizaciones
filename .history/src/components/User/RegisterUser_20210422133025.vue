      ...
      <div class="flex-container">
        ...
        <div class="form__datos">
          ...
          <div class="form__section2">
            ...
            <div
              class="form_check-error"
              v-if="!$v.users.contrasena.containsUppercase"
            >
              Ingrese minimo una Mayuscula.
            </div>
            <div
              class="form_check-error"
              v-if="!$v.users.contrasena.containsNumber"
            >
              Ingrese mínimo un Número.
            </div>
            <div
              class="form_check-error"
              v-if="!$v.users.contrasena.containsSpecial"
            >
              Ingrese mínimo un Número.
            </div>
          </div>
